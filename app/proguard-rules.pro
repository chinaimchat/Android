...
-keep class com.chat.base.endpoint.entity.** { *; }
#----------登录模块---------------
...
-keep class com.chat.uikit.workplace.** { *; }
#----------群管理-----------------
...
#----------工作台------------------
-keep class com.chat.uikit.workplace.WorkplaceCategory { *; }
-keep class com.chat.uikit.workplace.WorkplaceApp { *; }
#----------组织架构------------------
