...
import com.chat.base.utils.WKErrorMessageNormalizer;
...
public abstract class WKBaseActivity<WKVBinding extends ViewBinding> extends SwipeBackActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // 禁止横屏：Android 8.0 透明主题下 setRequestedOrientation 会抛
        // IllegalStateException("Only fullscreen opaque activities can request orientation")
        // 这里兜底，全局锁竖屏交给 TSApplication 的 ActivityLifecycleCallbacks。
        try {
...
//    }
    ...
    protected void showSingleBtnDialog(String content) {
        WKDialogUtils.getInstance().showSingleBtnDialog(this, "", WKErrorMessageNormalizer.normalize(content), "", null);
    }

    protected void showToast(String content) {
        WKToastUtils.getInstance().showToastFail(WKErrorMessageNormalizer.normalize(content));
    }
