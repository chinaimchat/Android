...
public class WKContentType extends WKMsgContentType {
    ...
    // 红包
    public final static int WK_REDPACKET = 9;
    // 转账消息
    public final static int WK_TRANSFER = 10;
    // 富文本
    ...
    // 红包领取tip（由服务端下发）
    public final static int redpacketOpen = 1011;
    // 交易系统通知（转账退回、红包退回等）
    public final static int tradeSystemNotify = 1012;
    /** 钱包余额 IM 同步（与后端 WalletIMSyncPayloadType 对齐，勿当普通气泡展示） */
    public final static int WK_WALLET_BALANCE_SYNC = 1020;
