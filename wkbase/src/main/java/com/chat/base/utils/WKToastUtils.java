...
public class WKToastUtils {
    ...
    private void showToast(String msg, int type) {
        String normalizedMsg = WKErrorMessageNormalizer.normalize(msg);
        Toast toast = Toast.makeText(WKBaseApplication.getInstance().getContext(), normalizedMsg, Toast.LENGTH_SHORT);
