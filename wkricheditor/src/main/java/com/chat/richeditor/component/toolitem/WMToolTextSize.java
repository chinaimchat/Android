...
import com.chat.richeditor.component.wmview.WMButton;
import com.chat.richeditor.component.wmview.WMEditText;
import com.chat.richeditor.component.wmview.WMHorizontalScrollView;
...
public class WMToolTextSize extends WMToolItem implements View.OnClickListener {
    ...
    public List<View> getView(final Context context) {
        ...
        view = button;
        button.setTextColor(ContextCompat.getColor(context, R.color.popupTextColor));
        view.setOnClickListener(v -> {
            ...
            for (int i = 12; i < 30; i += 2) {
                ...
                b.setTextColor(ContextCompat.getColor(context,R.color.colorDark));
