...
public class WKScanActivity extends BarcodeCameraScanActivity {
    ...
    /** 为提币填地址等场景：扫码后直接 {@link #setResult} 返回内容，不走 URL / 加好友等业务分流。 */
    public static final String EXTRA_RETURN_RAW_ONLY = "return_raw_only";
    ...
    private void handleResult(String result) {
        if (getIntent().getBooleanExtra(EXTRA_RETURN_RAW_ONLY, false)) {
            Intent data = new Intent();
            data.putExtra(EXTRA_SCAN_RESULT, result != null ? result : "");
