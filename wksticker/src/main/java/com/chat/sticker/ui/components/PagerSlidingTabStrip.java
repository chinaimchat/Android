...
//        pager.setOnPageChangeListener(pageListener);
    ...
    private void addIconTab(final int position, Drawable drawable, CharSequence contentDescription) {
        ImageView tab = new AppCompatImageView(getContext()) {
            @Override
            ...
            public void setSelected(boolean selected) {
                ...
                if (Build.VERSION.SDK_INT >= 21 && background != null) {
                    int color = selected ? 0xff2b97e2 : 0xff8c9197;
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            RippleDrawable rippleDrawable = (RippleDrawable) Theme.createSelectorDrawable(0xff8c9197);
