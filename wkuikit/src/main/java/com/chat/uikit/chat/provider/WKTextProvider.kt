                    ...
                    override fun onClick() {
                        ...
                        if (!TextUtils.isEmpty(selectText)) {
                            ...
                            (getAdapter() as? ChatAdapter)?.conversationContext?.let { ctx ->
                                ...
                                favoritePopupMenu.iPopupItemClick.onClick(mMsg, ctx)
                            }
                        }
                    }
                })
                    ...
                    if (StringUtils.isMobile(content)) {
                        ...
                        list.add(
                            BottomSheetItem(
                                ...
                                object : BottomSheetItem.IBottomSheetClick {
                                    override fun onClick() {
                                        val activity = (chatAdapter?.conversationContext?.chatActivity as? FragmentActivity)
...
//    }
    ...
    private fun shotTipsMsg(mTextContent: WKTextContent) {
        ...
        (getAdapter() as? ChatAdapter)?.showTipsMsg(clientMsgNo)
    }
